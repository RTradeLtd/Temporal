...
func (api *API) stripeCharge(c *gin.Context) {
	...
	// set the token generated by stripe
	chargeParams.SetSource(forms["stripe_token"])
	// metadata can be used for better Radar validation
	chargeParams.AddMetadata("order_type", "temporal.credits")
