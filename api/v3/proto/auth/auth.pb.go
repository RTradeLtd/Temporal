...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_2b6aaac0dbee1cd8, []int{0}
}
...
func init() {
	proto.RegisterType((*Message)(nil), "auth.Message")
}
...
func (c *temporalAuthClient) Status(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/auth.TemporalAuth/Status", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TemporalAuth_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TemporalAuthServer).Status(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.TemporalAuth/Status",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemporalAuthServer).Status(ctx, req.(*Message))
	}
...
var _TemporalAuth_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Status",
			Handler:    _TemporalAuth_Status_Handler,
		},
	},
...
func init() { proto.RegisterFile("auth/auth.proto", fileDescriptor_auth_2b6aaac0dbee1cd8) }

var fileDescriptor_auth_2b6aaac0dbee1cd8 = []byte{
	...
	0xe3, 0x1a, 0xf9, 0x73, 0xf1, 0x84, 0xa4, 0xe6, 0x16, 0xe4, 0x17, 0x25, 0xe6, 0x38, 0x96, 0x96,
	0x64, 0x08, 0xd9, 0x73, 0xb1, 0x05, 0x97, 0x24, 0x96, 0x94, 0x16, 0x0b, 0xf1, 0xea, 0x81, 0xed,
	...
	0x00, 0x00, 0xff, 0xff, 0xf3, 0x40, 0x98, 0x7b, 0xb3, 0x00, 0x00, 0x00,
}
