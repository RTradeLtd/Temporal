...
import (
	...
	cs "gx/ipfs/QmcGgFLHMFLcNMMvxsBC5LeLqubLR5djxjShVU3koVMtVq/go-conn-security"
	cst "gx/ipfs/QmcGgFLHMFLcNMMvxsBC5LeLqubLR5djxjShVU3koVMtVq/go-conn-security/test"
)
